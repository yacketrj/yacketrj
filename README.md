...
### [Dune: Awakening Self-Hosted Docker](https://github.com/yacketrj/dune-awakening-selfhost-docker)
...
### [Dune Ops Observability](https://github.com/yacketrj/dune-ops-observability-addon)
...
### [ACP Ops Monitor](https://github.com/yacketrj/acp-ops-monitor)
...
### [Dune Docker Addons](https://github.com/yacketrj/dune-docker-addons)
...
| Repository | Area |
|---|---|
| [`dune-awakening-selfhost-docker`](https://github.com/yacketrj/dune-awakening-selfhost-docker) | Containerized server platform and browser-based administration |
| [`dune-awakening-selfhost-docker-core`](https://github.com/yacketrj/dune-awakening-selfhost-docker-core) | Core platform development and integration work |
| [`dune-ops-observability-addon`](https://github.com/yacketrj/dune-ops-observability-addon) | Read-only operations, SOC/NOC, and Prometheus visibility |
| [`acp-ops-monitor`](https://github.com/yacketrj/acp-ops-monitor) | SRE monitoring, synchronization safety, and CI automation |
| [`dune-docker-addons`](https://github.com/yacketrj/dune-docker-addons) | Community addon catalog and lifecycle governance |
| [`icarus_modding`](https://github.com/yacketrj/icarus_modding) | Game-server and modding experimentation |
| [`Python-PalServer`](https://github.com/yacketrj/Python-PalServer) | Legacy Python server-management project |
